...
std::list<DefaultCurrency> DefaultDataForDb::dataCurrencies()
{
    ...
    currencies.push_back({"AMD", "Armenian Dram", "֏", true});
    ...
    currencies.push_back({"BRL", "Brazilian Real", "R$", true});
    currencies.push_back({"BSD", "Bahamian Dollar", "$"});
    currencies.push_back({"BTN", "Ngultrum", "Nu."});
    currencies.push_back({"BWP", "Pula", "P"});
    currencies.push_back({"BYN", "Belarussian Ruble", "Br", true});
    currencies.push_back({"BZD", "Belize Dollar", "$"});
    currencies.push_back({"CAD", "Canadian Dollar", "$", true});
    currencies.push_back({"CDF", "Franc Congolais", "Fr"});
    currencies.push_back({"CHF", "Swiss Franc", "Fr", true});
    currencies.push_back({"CLP", "Chilean Peso", "$", true});
    currencies.push_back({"CNY", "Yuan Renminbi", "元", true});
    ...
    currencies.push_back({"CZK", "Czech Koruna", "Kč", true});
    ...
    currencies.push_back({"EUR", "Euro", "€", true});
    currencies.push_back({"FJD", "Fiji Dollar", "$"});
    currencies.push_back({"FKP", "Falkland Islands Pound", "£"});
    currencies.push_back({"GBP", "Pound Sterling", "£", true});
    currencies.push_back({"GEL", "Lari", "ლ", true});
    ...
    currencies.push_back({"HKD", "Hong Kong Dollar", "$", true});
    currencies.push_back({"HNL", "Lempira", "L"});
    currencies.push_back({"HRK", "Croatian Kuna", "kn"});
    currencies.push_back({"HTG", "Haiti Gourde", "G"});
    currencies.push_back({"HUF", "Forint", "Ft", true});
    currencies.push_back({"IDR", "Rupiah", "Rp", true});
    currencies.push_back({"ILS", "New Israeli Shekel", "₪", true});
    currencies.push_back({"INR", "Indian Rupee", "₹", true});
    ...
    currencies.push_back({"MXN", "Mexican Peso", "$", true});
    currencies.push_back({"MYR", "Malaysian Ringgit", "RM", true});
    ...
    currencies.push_back({"NOK", "Norwegian Krone", "kr", true});
    currencies.push_back({"NPR", "Nepalese Rupee", "₨"});
    currencies.push_back({"NZD", "New Zealand Dollar", "$", true});
    ...
    currencies.push_back({"PHP", "Philippine Peso", "₱", true});
    currencies.push_back({"PKR", "Pakistan Rupee", "₨", true});
    currencies.push_back({"PLN", "Zloty", "zł", true});
    ...
    currencies.push_back({"SEK", "Swedish Krona", "kr", true});
    currencies.push_back({"SGD", "Singapore Dollar", "$", true});
    ...
    currencies.push_back({"THB", "Baht", "฿", true});
    currencies.push_back({"TJS", "Somoni", "ЅМ", true});
    currencies.push_back({"TMT", "Manat", "m", true});
    currencies.push_back({"TND", "Tunisian Dinar", "د.ت"});
    currencies.push_back({"TOP", "Pa'anga", "T$"});
    currencies.push_back({"TRY", "New Turkish Lira", "₺", true});
    currencies.push_back({"TTD", "Trinidad and Tobago Dollar", "$"});
    currencies.push_back({"TWD", "New Taiwan dollar", "$", true});
    currencies.push_back({"UAH", "Hryvnia", "₴", true});
    currencies.push_back({"UGX", "Uganda Shilling", "Sh"});
    currencies.push_back({"USD", "US Dollar", "$", true});
    currencies.push_back({"UYU", "Peso Uruguayo", "$"});
    currencies.push_back({"UZS", "Uzbekistan Som", "so’m", true});
    ...
    currencies.push_back({"ZAR", "South African Rand", "R", true});

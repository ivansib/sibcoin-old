...
std::list<DefaultCountry> dex::DefaultDataForDb::dataCountries()
{
    ...
    countries.push_back({"BY", "Belarus", "BYR"});
    ...
    countries.push_back({"BO", "Bolivia, Plurinational State of", "BOB"});
    countries.push_back({"BQ", "Bonaire, Sint Eustatius and Saba", "USD"});
    ...
    countries.push_back({"CF", "Central African Republic", "XAF"});
    ...
    countries.push_back({"CC", "Cocos (Keeling) Islands", "AUD"});
    countries.push_back({"CO", "Colombia", "COP"});
    countries.push_back({"KM", "Comoros", "KMF"});
    countries.push_back({"CG", "Congo", "CDF"});
    countries.push_back({"CD", "Congo, the Democratic Republic of the", "CDF"});
    ...
    countries.push_back({"CZ", "Czech Republic", "CZK"});
    ...
    countries.push_back({"FK", "Falkland Islands (Malvinas)", "FKP"});
    ...
    countries.push_back({"VA", "Holy See (Vatican City State)", "EUR"});
    ...
    countries.push_back({"IR", "Iran, Islamic Republic of", "IRR"});
    ...
    countries.push_back({"PS", "Palestine, State of", "EGP"});
    ...
    countries.push_back({"MF", "Saint Martin (French part)", "EUR"});
    ...
    countries.push_back({"SX", "Sint Maarten (Dutch part)", "ANG"});
    ...
    countries.push_back({"SY", "Syrian Arab Republic", "SYP"});
    countries.push_back({"TW", "Taiwan, Province of China", "CNY"});
    countries.push_back({"TJ", "Tajikistan", "TJS"});
    countries.push_back({"TZ", "Tanzania, United Republic of", "TZS"});
    ...
    countries.push_back({"TM", "Turkmenistan", "TMM"});
    ...
    countries.push_back({"AE", "United Arab Emirates", "AED"});
    countries.push_back({"GB", "United Kingdom", "GBP"});
    countries.push_back({"US", "United States", "USD"});
    ...
    countries.push_back({"VE", "Venezuela, Bolivarian Republic of", "VEF"});
    countries.push_back({"VN", "Viet Nam", "VND"});
    countries.push_back({"VG", "Virgin Islands, British", "USD"});
    countries.push_back({"VI", "Virgin Islands, U.S.", "USD"});
...
std::list<DefaultCurrency> DefaultDataForDb::dataCurrencies()
{
    ...
    currencies.push_back({"AMD", "Armenian Dram", "֏"});
    ...
    currencies.push_back({"AUD", "Australian Dollar", "$"});
    currencies.push_back({"AWG", "Aruban Guilder", "ƒ"});
    currencies.push_back({"AZN", "Azerbaijanian Manat", "₼"});
    ...
    currencies.push_back({"BYR", "Belarussian Ruble", "Br"});
    ...
    currencies.push_back({"GBP", "Pound Sterling", "£"});
    currencies.push_back({"GEL", "Lari", "ლ"});
    ...
    currencies.push_back({"HKD", "Hong Kong Dollar", "$"});
    currencies.push_back({"HNL", "Lempira", "L"});
    currencies.push_back({"HRK", "Croatian Kuna", "kn"});
    currencies.push_back({"HTG", "Haiti Gourde", "G"});
    currencies.push_back({"HUF", "Forint", "Ft"});
    currencies.push_back({"IDR", "Rupiah", "Rp"});
    currencies.push_back({"ILS", "New Israeli Shekel", "₪"});
    currencies.push_back({"INR", "Indian Rupee", "₹"});
    ...
    currencies.push_back({"JPY", "Japanese yen", "¥"});
    currencies.push_back({"KES", "Kenyan Shilling", "Sh"});
    currencies.push_back({"KGS", "Som", "лв"});
    ...
    currencies.push_back({"KZT", "Tenge", "₸"});
    ...
    currencies.push_back({"MXN", "Mexican Peso", "$"});
    currencies.push_back({"MYR", "Malaysian Ringgit", "RM"});
    ...
    currencies.push_back({"NOK", "Norwegian Krone", "kr"});
    currencies.push_back({"NPR", "Nepalese Rupee", "₨"});
    currencies.push_back({"NZD", "New Zealand Dollar", "$"});
    ...
    currencies.push_back({"PHP", "Philippine Peso", "₱"});
    currencies.push_back({"PKR", "Pakistan Rupee", "₨"});
    currencies.push_back({"PLN", "Zloty", "zł"});
    ...
    currencies.push_back({"SEK", "Swedish Krona", "kr"});
    currencies.push_back({"SGD", "Singapore Dollar", "$"});
    ...
    currencies.push_back({"THB", "Baht", "฿"});
    currencies.push_back({"TJS", "Somoni", "ЅМ"});
    currencies.push_back({"TMM", "Manat", "m"});
    currencies.push_back({"TND", "Tunisian Dinar", "د.ت"});
    currencies.push_back({"TOP", "Pa'anga", "T$"});
    currencies.push_back({"TRY", "New Turkish Lira", "₺"});
    currencies.push_back({"TTD", "Trinidad and Tobago Dollar", "$"});
    currencies.push_back({"UAH", "Hryvnia", "₴"});
    currencies.push_back({"UGX", "Uganda Shilling", "Sh"});
    currencies.push_back({"USD", "US Dollar", "$"});
    currencies.push_back({"UYU", "Peso Uruguayo", "$"});
    currencies.push_back({"UZS", "Uzbekistan Som", "so’m"});
    ...
    currencies.push_back({"ZAR", "South African Rand", "R"});
